<jsp:include page="../patrials/header.jsp" >
    <jsp:param name="firstname" value="${clienteDto.getNombre()}"/>
</jsp:include>
<div class="container-fluid">
    <div class="row vh-100">
        <div class="col-sm-2 justify-content-center d-flex  vh-80 panel_menu">
            <nav class="panel_menu-nav">
                <ul>
                    ...
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-car-front-fill" viewBox="0 0 16 16">
